...
interface IERC1261 {
    ...
    function modifyAttributeByIndex(address _to, uint256 _attributeIndex, uint256 _modifiedValueIndex) external;
    ...
    /// @param _attributeIndexes The attribute data associated with the member.
    ///  This is an array which contains indexes of attributes.
    function assignTo(address _to, uint256[] _attributeIndexes) external;
